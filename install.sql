...
('Version', 'SHIPPING_BOXES_MANAGER_VERSION', '2.2.0', 'Version Installed:', @configuration_group_id, 0, NOW(), NULL, NULL),
('Status', 'MODULE_SHIPPING_BOXES_MANAGER_STATUS', 'false', 'Use shipping boxes manager to calculate package weights/dimensions?', @configuration_group_id, 1, NOW(), NULL, 'zen_cfg_select_option(array(\'true\', \'false\'),'),
('Debug', 'MODULE_SHIPPING_BOXES_MANAGER_DEBUG', 'false', 'Enable debug mode output?', @configuration_group_id, 2, NOW(), NULL, 'zen_cfg_select_option(array(\'true\', \'false\'),');
...
INSERT IGNORE INTO admin_pages (page_key, language_key, main_page, page_params, menu_key, display_on_menu, sort_order) VALUES ('toolsShippingBoxesManager', 'BOX_SHIPPING_BOXES_MANAGER', 'FILENAME_SHIPPING_BOXES_MANAGER', '', 'tools', 'Y', @configuration_group_id);

# Register the tools page for Admin Access Control
INSERT IGNORE INTO admin_pages (page_key, language_key, main_page, page_params, menu_key, display_on_menu, sort_order) VALUES ('catalogProductsNestingManager', 'BOX_PRODUCTS_NESTING_MANAGER', 'FILENAME_PRODUCTS_NESTIN_MANAGER', '', 'tools', 'Y', @configuration_group_id);