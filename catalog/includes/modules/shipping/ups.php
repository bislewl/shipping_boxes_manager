...
class ups extends base {
  ...
  function info() {
    return MODULE_SHIPPING_UPS_INFO; // add a description here or leave blank to disable
  }
  ...
  function install() {
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Shipping Info', 'MODULE_SHIPPING_UPS_INFO', '', 'Add a description that will display in Fast and Easy AJAX Checkout', '6', '0', 'zen_cfg_textarea(', now())");
  ...
  function keys() {
    return array(
      ...
      'MODULE_SHIPPING_UPS_TAX_BASIS', 
      'MODULE_SHIPPING_UPS_ZONE',
      'MODULE_SHIPPING_UPS_INFO', 
